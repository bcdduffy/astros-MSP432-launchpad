...
#define USB_UART_PORT GPIO_PORT_P2
...
#define USB_UART_INSTANCE EUSCI_A1_BASE
 ...
 * an UART struct. Treat all members as PRIVATE - that is, you should ONLY
...
//       implemented.
/** Returns a char of the UART module given */
char UART_getChar(UART* uart_p);
/** Returns whether the UART module has a character or not*/
bool UART_hasChar(UART* uart_p);
/** Returns whether the UART module can send a character or not*/
bool UART_canSend(UART* uart_p);
/** Given the character parameter, places the character into the module */
